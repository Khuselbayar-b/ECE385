...
HD_PWD='C:/Users/realk/Desktop/ece385/ECE385/lab7_1/lab7_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_block_wrapper.tcl -notrace
