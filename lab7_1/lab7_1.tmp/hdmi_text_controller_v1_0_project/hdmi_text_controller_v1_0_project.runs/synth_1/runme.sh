...
HD_PWD='c:/users/kb40/desktop/ece385/lab7_1/lab7_1.tmp/hdmi_text_controller_v1_0_project/hdmi_text_controller_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_text_controller_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_text_controller_tb.tcl
