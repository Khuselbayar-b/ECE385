...
if (color % 2) {
		hdmi_ctrl->palette[color/2] = hdmi_ctrl->palette[color/2] & 0b00000000000000000001111111111110;
		hdmi_ctrl->palette[color/2] |= (red << 8 | green<<4 | blue << 0) <<13;
	} else {
		hdmi_ctrl->palette[color/2] = hdmi_ctrl->palette[color/2] & 0b00000001111111111110000000000000;
