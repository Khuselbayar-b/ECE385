...
`define SIM_VIDEO 
//Comment out to simulate AXI bus only
...
//    // Red Green and Blue values respectively - these come from your draw logic
  ...
  //   assign pixel_vs = hdmi_text_controller_v1_0_inst.vde;
    ...
    initial begin: TEST_VECTORS
       ...
       // @(posedge aclk) axi_write(8192, 32'h00000001);
        ...
        $info ("Read back of control register: %x", tb_read);
         //  @(posedge aclk) axi_read(8192, tb_read);
